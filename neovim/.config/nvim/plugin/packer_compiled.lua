...
_G.packer_plugins = {
  ...
  ["csv.vim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/csv.vim",
    url = "https://github.com/chrisbra/csv.vim"
  },
  ["fugitive-gitlab.vim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/fugitive-gitlab.vim",
    url = "https://github.com/shumphrey/fugitive-gitlab.vim"
  },
  fzf = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/fzf",
    url = "https://github.com/junegunn/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/fzf.vim",
  ...
  indentLine = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/indentLine",
    url = "https://github.com/Yggdroot/indentLine"
  },
  ["lsp-status.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/lsp-status.nvim",
  ...
  ["nvim-metals"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/nvim-metals",
  ...
  ["profile.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/profile.nvim",
    url = "https://github.com/stevearc/profile.nvim"
  },
  ["python-syntax"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/python-syntax",
  ...
  ["vim-terraform"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-terraform",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
    url = "https://github.com/hrsh7th/vim-vsnip-integ"
  },
  ["vscode-go"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vscode-go",
